...
import { Headline, SimpleMarkdown, focusRing } from "@/components/legacy";
  ...
  return (
    <div className="mx-auto max-w-6xl px-1 py-2 sm:px-4">
      <div className="mb-6 flex flex-wrap items-center justify-between gap-4">
        <div>
          <Headline level={1} className="text-2xl">{t.deskTitle}</Headline>
          {displayName ? <p className="mt-1 font-sans text-sm text-muted-foreground-foreground">{fillTemplate(t.deskWelcome, { name: displayName })}</p> : null}
        </div>
      ...
      <div className="mb-6 flex flex-wrap gap-2 border-b border-rule">
        <button
          ...
          className={`min-h-10 border-b-2 px-4 font-sans text-xs font-semibold uppercase tracking-wide ${activeTab === "queue" ? "border-ink text-ink" : "border-transparent text-muted-foreground hover:text-ink"}`}
        >
        ...
        <button
          ...
          className={`min-h-10 border-b-2 px-4 font-sans text-xs font-semibold uppercase tracking-wide ${activeTab === "boards" ? "border-ink text-ink" : "border-transparent text-muted-foreground hover:text-ink"}`}
        >
          {t.deskBoardsTab}
        </button>
        <button
          ...
          className={`min-h-10 border-b-2 px-4 font-sans text-xs font-semibold uppercase tracking-wide ${activeTab === "print" ? "border-ink text-ink" : "border-transparent text-muted-foreground hover:text-ink"}`}
        >
          {t.deskPrintTab}
        </button>
        <button
          ...
          className={`min-h-10 border-b-2 px-4 font-sans text-xs font-semibold uppercase tracking-wide ${activeTab === "sync" ? "border-ink text-ink" : "border-transparent text-muted-foreground hover:text-ink"}`}
        >
          {t.deskSyncTab}
        </button>
        <button
          ...
          className={`min-h-10 border-b-2 px-4 font-sans text-xs font-semibold uppercase tracking-wide ${activeTab === "flags" ? "border-ink text-ink" : "border-transparent text-muted-foreground hover:text-ink"}`}
        >
        ...
        <button
          ...
          className={`min-h-10 border-b-2 px-4 font-sans text-xs font-semibold uppercase tracking-wide ${activeTab === "projects" ? "border-ink text-ink" : "border-transparent text-muted-foreground hover:text-ink"}`}
        >
        ...
        <button
          ...
          className={`min-h-10 border-b-2 px-4 font-sans text-xs font-semibold uppercase tracking-wide ${activeTab === "dispatches" ? "border-ink text-ink" : "border-transparent text-muted-foreground hover:text-ink"}`}
        >
        ...
        <button
          ...
          className={`min-h-10 border-b-2 px-4 font-sans text-xs font-semibold uppercase tracking-wide ${activeTab === "orgs" ? "border-ink text-ink" : "border-transparent text-muted-foreground hover:text-ink"}`}
        >
        ...
        {role === "admin" ? (
          <button
            ...
            className={`min-h-10 border-b-2 px-4 font-sans text-xs font-semibold uppercase tracking-wide ${activeTab === "admin" ? "border-ink text-ink" : "border-transparent text-muted-foreground hover:text-ink"}`}
          >
      ...
      {isScoped ? (
        <p className="mb-4 font-sans text-xs text-muted-foreground-foreground">{(t as Record<string,string>).deskScopeFilteredHint}</p>
      ) : null}
      {actionError ? (
      ...
      {activeTab === "queue" ? (
        <div className="space-y-4">
          ...
          {queueLoading ? (
            <p className="font-sans text-sm text-muted-foreground-foreground">{t.deskQueueLoading}</p>
          ) : queueError ? (
            ...
            <p className="border border-rule bg-card px-4 py-8 text-center font-sans text-sm text-muted-foreground-foreground">{t.deskQueueEmpty}</p>
          ) : (
                  ...
                  <CardHeader className="pb-3">
                    <div className="flex flex-wrap items-start justify-between gap-2">
                      <CardTitle className="text-base">
                        ...
                        <span className="ml-2 font-sans text-xs font-normal text-muted-foreground-foreground">{item.category || (item.categories || []).join(", ")}</span>
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid gap-4 md:grid-cols-2">
                      <div className="border border-rule bg-paper p-3">
                        <p className="font-sans text-xs font-semibold uppercase tracking-wide text-muted-foreground">{t.deskQueuePublicPreview}</p>
                        ...
                        <p className="font-sans text-xs capitalize text-muted-foreground-foreground">{String(item.category || (item.categories || []).join(", "))}</p>
                      ...
                      <div className="border border-dashed border-rule bg-card p-3">
                        <p className="font-sans text-xs font-semibold uppercase tracking-wide text-muted-foreground">{t.deskQueuePrivateDetails}</p>
                        {item.beneficiary ? (
                        ...
                        {item.registrant ? (
                          ...
                          <p className="mt-2 font-sans text-xs text-muted-foreground-foreground">{t.deskNoRegistrant}</p>
                        )}
                        {item.dupCandidates && item.dupCandidates.length > 0 ? (
                          <div className="mt-3">
                            ...
                            <p className="font-sans text-xs text-muted-foreground-foreground">{t.deskQueueDupHint}</p>
                          </div>
                        ) : (
                          <p className="mt-3 font-sans text-xs text-muted-foreground-foreground">{t.deskQueueDupEmpty}</p>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      <Button
                        ...
                        className={!publishConfirmed[item.id] ? "border-subtle text-muted-foreground disabled:opacity-100" : ""}
      ...
      {activeTab === "boards" ? (
        <div className="space-y-4">
          ...
          {boardsLoading ? (
            <p className="font-sans text-sm text-muted-foreground-foreground">{t.deskBoardsLoading}</p>
          ) : filteredNeeds.length === 0 ? (
            <p className="border border-rule bg-card px-4 py-8 text-center font-sans text-sm text-muted-foreground-foreground">{t.deskBoardsEmpty}</p>
          ) : (
            <div className="grid gap-4">
                ...
                <Card key={need.id}>
                  <CardHeader className="pb-2">
                    ...
                    {claimCode ? (
                      <div className="mt-2 border border-rule bg-paper px-3 py-2">
                        <p className="font-sans text-xs font-semibold uppercase tracking-wide text-muted-foreground">{t.deskClaimCode}</p>
                  ...
                  <CardContent className="space-y-3">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex flex-wrap gap-2">
                        <NativeSelect value={selectedOfferId[need.id] || ""} onChange={(e) => setSelectedOfferId((p) => ({ ...p, [need.id]: e.target.value }))}>
                      ...
                      {filteredOffers.length === 0 ? <p className="font-sans text-xs text-muted-foreground-foreground">{t.deskNoOffersHint}</p> : null}
                            ...
                            {Object.entries(matchedContact[need.id] as Record<string, unknown>)
                              ...
                              .map(([k, v]) => (
                                <div key={k} className="flex gap-2">
                                  <dt className="min-w-[4rem] font-semibold capitalize text-muted-foreground">{k}</dt>
      ...
      {activeTab === "print" ? (
        <div className="space-y-4">
          ...
          <p className="font-sans text-sm text-muted-foreground-foreground">{t.deskPrintLead}</p>
          <Card>
            <CardContent className="space-y-4 pt-6">
              <div className="flex flex-wrap gap-4 no-print">
                <div className="min-w-[14rem]">
                  <Label>{t.deskPrintDistrict}</Label>
                  <NativeSelect value={printDistrict} onChange={(e) => setPrintDistrict(e.target.value)}>
                    {(isScoped ? (auth.profile?.districts ?? []) as typeof districtNames : districtNames).map((d) => (
                      <NativeSelectOption key={d as string} value={d as string}>
                ...
                <div className="min-w-[8rem]">
                  ...
                  <NativeSelect value={printWard} onChange={(e) => setPrintWard(e.target.value)}>
              ...
              {printLoading ? <p className="font-sans text-sm text-muted-foreground-foreground">{t.deskBoardsLoading}</p> : null}
              {!printLoading && !printError && filteredPrintItems.length === 0 ? <p className="font-sans text-sm text-muted-foreground-foreground">{t.deskPrintEmpty}</p> : null}
              {filteredPrintItems.length > 0 ? (
                <div className="overflow-x-auto border border-rule bg-paper print:border-black print:bg-white">
                  <div className="p-4 text-center print:block">
                    ...
                    <p className="font-sans text-xs text-muted-foreground-foreground">{t.deskPrintTitle}</p>
                  </div>
                  <Table>
                    <TableHeader>
                      <TableRow>
      ...
      {activeTab === "sync" ? (
        <div className="space-y-4">
          ...
          <p className="font-sans text-sm text-muted-foreground-foreground">{t.deskSyncLead}</p>
          <Card>
            <CardContent className="space-y-4 pt-6">
              <div className="space-y-2">
      ...
      {activeTab === "dispatches" ? (
        <div className="space-y-4">
          ...
          {dispatchesLoading ? <p className="font-sans text-sm text-muted-foreground-foreground">{(t as Record<string,string>).deskDispatchesLoading}</p> : dispatchesError ? <p className="font-sans text-sm text-destructive" role="alert">{dispatchesError}</p> : dispatches.length===0 ? <p className="border border-rule bg-card px-4 py-8 text-center font-sans text-sm text-muted-foreground-foreground">{(t as Record<string,string>).deskDispatchesEmpty}</p> : (
            <div className="grid gap-4">
              {dispatches.map(d=> {
                ...
                <Card key={d.id} className="overflow-hidden">
                  ...
                  <CardContent className="space-y-3">
                    ...
                    <div className="border border-dashed border-rule bg-card p-3">
                      <p className="font-sans text-xs font-semibold uppercase tracking-wide text-muted-foreground">{ds.dispatchPrivateLabel}</p>
                      <p className="mt-2 font-sans text-sm"><span className="font-semibold">Email:</span> {d.author.email}</p>
                      <p className="font-sans text-xs text-muted-foreground-foreground">{(t as Record<string,string>).dispatchWriteEmailHint}</p>
                    </div>
                    <div className="flex flex-wrap gap-2">
          ...
          <Dialog open={!!dispatchRejectId} onOpenChange={(open)=>{ if (!open) { setDispatchRejectId(null); setDispatchRejectCode(""); setDispatchRejectDetail(""); setDispatchRejectError(null); }}}>
            <DialogContent>
              ...
              <div className="space-y-2">
                ...
                <p className="font-sans text-xs text-muted-foreground-foreground">{ds.rejectReasonHelper}</p>
        ...
        <div className="space-y-4">
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              >
                <NativeSelectOption value="pending">{dos.orgsStatusPending}</NativeSelectOption>
                <NativeSelectOption value="verified">{dos.orgsStatusVerified}</NativeSelectOption>
                <NativeSelectOption value="suspended">{dos.orgsStatusSuspended}</NativeSelectOption>
                <NativeSelectOption value="rejected">{dos.orgsStatusRejected}</NativeSelectOption>
              </select>
          ...
          {orgsLoading ? (
            <p className="font-sans text-sm text-muted-foreground">{dos.orgsLoading}</p>
          ) : orgsError ? (
            <div className="space-y-2">
              <p className="font-sans text-sm text-destructive" role="alert">
                {orgsError}
            ...
            <p className="border border-rule bg-card px-4 py-8 text-center font-sans text-sm text-muted-foreground">{dos.orgsEmpty}</p>
          ) : (
            <div className="grid gap-4">
              {orgs.map((org) => (
                <Card key={org.id} className="overflow-hidden">
                  ...
                  <CardContent className="space-y-3">
                    ...
                    {org.vouches && org.vouches.length > 0 ? (
                      <div className="border border-dashed border-rule bg-card p-3">
                        <p className="font-sans text-xs font-semibold uppercase tracking-wide text-muted-foreground">{dos.orgVouchesLabel}</p>
                    ...
                    {org.status === "verified" && org.tier ? (
                      <div className="border border-rule bg-card p-3">
                        <p className="font-sans text-xs font-semibold uppercase tracking-wide text-muted-foreground">{dos.orgTierLabel}</p>
                        <p className="font-sans text-sm font-semibold">
                          {org.tier === "known" ? dos.orgTierKnownShort : org.tier === "vouched" ? dos.orgTierVouchedShort : dos.orgTierSelfDeclaredShort}
                        </p>
                        {org.verificationNote ? <p className="mt-1 font-sans text-sm italic text-muted-foreground">{org.verificationNote}</p> : null}
                      </div>
                    ) : null}
              ...
              <div className="space-y-3">
                <div className="space-y-2">
                  ...
                  <select id="orgVerifyTier" value={orgVerifyTier} onChange={(e) => setOrgVerifyTier(e.target.value as OrgTier)} className={"flex min-h-11 w-full border border-ink bg-paper px-3 py-2 font-sans text-sm " + focusRing}>
                    <NativeSelectOption value="known">{dos.orgTierKnown}</NativeSelectOption>
                    <NativeSelectOption value="vouched">{dos.orgTierVouched}</NativeSelectOption>
                    <NativeSelectOption value="self_declared">{dos.orgTierSelfDeclared}</NativeSelectOption>
                  </select>
                </div>
                <div className="space-y-2">
      ...
      {activeTab === "flags" ? (
        <div className="space-y-4">
          ...
          {flagsLoading ? (
            <p className="font-sans text-sm text-muted-foreground-foreground">{t.deskFlagsLoading}</p>
          ) : flagsError ? (
            <p className="font-sans text-sm text-destructive" role="alert">{flagsError}</p>
          ) : flags.length === 0 ? (
            <p className="border border-rule bg-card px-4 py-8 text-center font-sans text-sm text-muted-foreground-foreground">{t.deskFlagsEmpty}</p>
          ) : (
            <div className="grid gap-4">
              {flags.map((item) => (
                <Card key={item.needId}>
                  <CardHeader className="pb-2">
                    <div className="flex items-center justify-between gap-2">
                      ...
                      <span className="font-sans text-xs text-muted-foreground-foreground">{item.district}</span>
                    </div>
                    ...
                    <ul className="space-y-2">
                      {item.flags.map((f, idx) => (
                        <li key={idx} className="border border-rule bg-card px-3 py-2">
                          ...
                          <p className="mt-1 font-sans text-xs text-muted-foreground-foreground">{new Date(f.createdAt).toLocaleString()}</p>
                        </li>
                      ))}
                    </ul>
                  </CardContent>
          ...
          <div className="mt-8 space-y-4 border-t border-rule pt-6">
            ...
            {centerFlagsLoading ? (
              <p className="font-sans text-sm text-muted-foreground-foreground">{dos.centerFlagsLoading}</p>
            ) : centerFlagsError ? (
              <p className="font-sans text-sm text-destructive" role="alert">{centerFlagsError}</p>
            ) : centerFlags.length === 0 ? (
              <p className="border border-rule bg-card px-4 py-6 text-center font-sans text-sm text-muted-foreground-foreground">{dos.centerFlagsEmpty}</p>
            ) : (
              <div className="grid gap-4">
                {centerFlags.map((cf) => (
                      ...
                      <ul className="space-y-2">
                        {cf.reasons.map((r, idx) => (
                          <li key={idx} className="border border-rule bg-card px-3 py-2">
                            ...
                            <p className="mt-1 font-sans text-xs text-muted-foreground-foreground">{new Date(r.createdAt).toLocaleString()}</p>
                          </li>
                        ))}
                      </ul>
                    </CardContent>
      ...
      {activeTab === "projects" ? (
        <div className="space-y-4">
          ...
          {projectsLoading ? <p className="font-sans text-sm text-muted-foreground-foreground">{(t as Record<string,string>).deskProjectsLoading}</p> : projectsError ? <p className="font-sans text-sm text-destructive" role="alert">{projectsError}</p> : filteredProjects.length===0 ? <p className="border border-rule bg-card px-4 py-8 text-center font-sans text-sm text-muted-foreground-foreground">{(t as Record<string,string>).deskProjectsEmpty}</p> : (
            <div className="grid gap-4">
                ...
                <Card key={p.id}>
                  <CardHeader className="pb-2">
                    <div className="flex flex-wrap items-center justify-between gap-2">
                      ...
                      <span className="font-sans text-xs text-muted-foreground-foreground">{p.district} · W{p.ward}</span>
                    </div>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <p className="font-sans text-xs text-muted-foreground-foreground">{p.locationText}</p>
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      <div className="flex items-center gap-1">
                        <NativeSelect value={statusSelect[p.id] || p.status} onChange={e=> setStatusSelect(prev=> ({...prev, [p.id]: e.target.value}))}>
                          {["pending","published","in-progress","completed","rejected","archived"].map(s=> <NativeSelectOption key={s} value={s}>{s}</NativeSelectOption>)}
                        </NativeSelect>
                        ...
                        <div className="grid gap-3">
                          {pendingU.map(u=> (
                            <div key={u.id} className="border border-rule bg-card p-3">
                              ...
                              {u.spentNpr!=null ? <p className="font-sans text-xs text-muted-foreground-foreground">Spent NPR {u.spentNpr}</p> : null}
      ...
      {activeTab === "admin" && role === "admin" ? (
        <div className="space-y-6">
            ...
            <CardContent className="space-y-4">
              ...
              {adminLookupUser ? (
                <div className="border border-rule bg-paper p-4 font-sans text-sm space-y-3">
                  ...
                  <p className="text-xs text-muted-foreground-foreground">Current: {adminLookupUser.role} · {(adminLookupUser.districts ?? []).join(", ") || (t as Record<string,string>).deskScopeAll} {adminLookupUser.guidelinesAckAt ? "· acked" : "· not acked"}</p>
                  <div>
                    <Label>{(t as Record<string,string>).deskAdminRoleLabel}</Label>
                    <NativeSelect value={adminRole} onChange={(e)=> setAdminRole(e.target.value)}>
                      <NativeSelectOption value="helper">{(t as Record<string,string>).deskAdminRoleHelper}</NativeSelectOption>
                      <NativeSelectOption value="moderator">{(t as Record<string,string>).deskAdminRoleModerator}</NativeSelectOption>
                      <NativeSelectOption value="admin">{(t as Record<string,string>).deskAdminRoleAdmin}</NativeSelectOption>
                    </NativeSelect>
                  </div>
                  <div>
          ...
          <Card>
            ...
            <CardContent>
              {adminModeratorsLoading ? <p className="font-sans text-sm text-muted-foreground-foreground">{(t as Record<string,string>).deskAdminModeratorsLoading}</p> : adminModerators.length===0 ? <p className="font-sans text-sm text-muted-foreground-foreground">{(t as Record<string,string>).deskAdminModeratorsEmpty}</p> : (
                <div className="space-y-2">
                  {adminModerators.map((u)=> (
                    <div key={u.sub} className="border border-rule bg-paper p-3 font-sans text-sm">
                      ...
                      <p className="text-xs text-muted-foreground-foreground">{u.role} · {(u.districts ?? []).join(", ") || (t as Record<string,string>).deskScopeAll} · {new Date(u.createdAt).toLocaleDateString()}</p>
                    </div>
                  ))}
                </div>
              )}
          ...
          <Card>
            ...
            <CardContent className="space-y-2 font-sans text-sm">
              {adminStatsLoading ? <p className="text-muted-foreground-foreground">{(t as Record<string,string>).deskAdminStatsLoading}</p> : adminStatsError ? <p className="text-destructive" role="alert">{adminStatsError}</p> : adminStats ? (
                <>
