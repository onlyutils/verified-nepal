import { EmergencyContacts } from "./dashboard";
import { labels } from "./i18n";
import type { Language, Page } from "./types";
import { Headline, Rule, SectionLabel, SquareButton, Standfirst } from "./ui";
import { opmcmMissingPersonUrl, opmcmUnidentifiedUrl } from "./urls";
...
export function MissingGuide({ language, navigate }: { language: Language; navigate: (page: Page) => void }) {
  ...
  return (
    <div className="mx-auto max-w-[52rem] space-y-10">
      ...
      <p className="max-w-[40rem] font-serif leading-7 text-muted">{c.closing}</p>
    </div>
  );
}
