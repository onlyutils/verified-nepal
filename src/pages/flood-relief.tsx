...
export function FloodReliefPage({ language, navigate }: { language: Language; navigate: (page: Page, sectionId?: string) => void }) {
  ...
  return (
    <div className="mx-auto flex max-w-7xl flex-col gap-8">
      <div className="flex flex-col gap-6">
        ...
        <Card>
          <CardContent className="grid gap-4 p-5 sm:grid-cols-2 sm:items-end">
            <label className="flex min-w-0 flex-col gap-2 text-sm font-semibold" htmlFor="flood-relief-district">
              {strings.districtLabel}
              <NativeSelect id="flood-relief-district" value={district} onChange={(event) => setDistrict(event.target.value)}>
            ...
            <label className="flex min-w-0 flex-col gap-2 text-sm font-semibold" htmlFor="flood-relief-category">
              {strings.categoryLabel}
              <NativeSelect
                id="flood-relief-category"
                value={category}
      ...
      <div className="mt-3 flex flex-wrap justify-end gap-2">
        <ShareButton
          filename="flood-relief-drop-centers.png"
